    ...
    for row in tqdm(f, total=n_rows):
        ...
        d = {
            **d,
            ...
            "numcitedby": int(row.pop("numcitedby")),
...
if __name__ == "__main__":
    ...
    parser.add_argument("csv_file", type=str, help="the CSV file to parse")
    parser.add_argument(
        "output_dir", type=str, help="the directory to output the JSON files"
    )
